...
namespace serialize_xml
{
    ...
    {
        createXML(filename);
        serializing_xml::serialize_xml(idx, "element_1", filename);
        serializing_xml::serialize_xml(name, "element_2", filename);
        serializing_xml::serialize_xml(data, "element_3", filename);
    }
